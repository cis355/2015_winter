...
<body>
    <div class="container">
    		<div class="row">
    			<h3>Cards: Terms and Defintions</h3>
				<h6>Please enter your terms here AND attached a text document in CANVAS. Each person must atach text document for credit. </h6>
    		</div>
			<div class="row">
				<p>
				...
				<table class="table table-striped table-bordered">
		              ...
		              <?php 
					   ...
					   $sql = 'SELECT * FROM cards ORDER BY term';
